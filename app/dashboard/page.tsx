...
export default function DashboardPage() {
  ...
  const [selectedPokemon, setSelectedPokemon] = useState<{ stats: PokemonStats; imagePath: string } | null>(null)
  const [capturedPokemon, setCapturedPokemon] = useState<Array<{ stats: PokemonStats; imagePath: string }>>([])
